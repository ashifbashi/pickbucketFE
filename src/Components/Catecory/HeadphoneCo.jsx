...
const HeadphoneCo = () => {
    ...
    const getAllHeadphoneData=()=>{      
     
        AxiosInstance.get('users/getAllHeadphoneData').then((response)=>{
          setHeadphoneData(response.data.response)
        })
